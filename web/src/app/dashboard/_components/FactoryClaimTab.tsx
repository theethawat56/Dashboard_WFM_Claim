      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-slate-500">
            จับคู่งานซ่อม/เคลมกับ PO ต่างประเทศ · แสดงเฉพาะงานในประกัน (ไม่เกิน 365 วันจากวันรับประกัน) · วันรับประกัน = วันลงทะเบียนเลื่อนไป 14 วัน · ถ้าไม่มีใช้วันสร้างงาน
          </p>
        </div>
                    ...
                    <tr key={m.task_id} className="border-b border-slate-100">
                      ...
                      <td className="px-3 py-2 whitespace-nowrap text-xs">
                        ...
                        <div className="text-slate-400">
                          {m.ref_date_source === "warranty_start_date" ? "วันรับประกัน" : m.ref_date_source === "create_date" ? "วันสร้างงาน" : "ไม่มีวันที่"}
                        </div>
                      </td>
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm text-slate-700">
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>วันรับประกันที่แสดงและใช้จับคู่ = วันลงทะเบียนรับประกันเลื่อนไป 14 วัน (เช่น ลงทะเบียน 1 ก.ย. → วันรับประกัน 18 ส.ค.) ใช้ทั้งงานซ่อม MNT และเคลม CLM</li>
              <li>แสดงเฉพาะงานในประกัน: อายุก่อนซ่อมไม่เกิน 365 วันจากวันรับประกันถึงวันสร้างงาน งานนอกประกันและงานที่ไม่มีวันประกันถูกตัดออก</li>
              ...
              <li>ยอดเคลมรวม (ผลเคลม) = ตัวเลขเดียวกับช่องยอดเคลมรวมในหน้าผลเคลม (รวมทุกบันทึก ไม่กรองปี/ในประกัน) ยอดคงเหลือ = ยอดเสียหาย − ยอดเคลมรวมนี้</li>
